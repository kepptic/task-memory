    ...
    Alpine.store('ui', {
        ...
        async submitTaskForm() {
            ...
            if (this.isEditMode) {
                ...
                this.showNotification(
                    window.translationSystem.t('notif.taskEdited', { id: this.editingTaskId }),
                    'success'
                );
            } else {
                // Create new task
        ...
        toggleFormSubtask(index) {
            if (this.formSubtasks[index]) {
                this.formSubtasks[index].completed = !this.formSubtasks[index].completed;
            }
        },
        ...
        async deleteCurrentTask() {
            ...
            const confirmKey = isArchived ? 'confirm.deleteTaskFromArchive' : 'confirm.deleteTask';
